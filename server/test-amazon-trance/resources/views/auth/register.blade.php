        ...
        <div class="py-6 sm:py-8 lg:py-12">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-center justify-center bg-gray-100 p-4">
                    <p class="text-center text-sm text-gray-500">アカウントをお持ちですか?
                        <a href="{{ route('login') }}" class="text-yellow-500 transition duration-100 hover:text-yellow-600 active:text-yellow-700">
                            Log in
                        </a>
                    </p>
                </div>
